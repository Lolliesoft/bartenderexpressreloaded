                ...
                while (rdr1.Read())
                {
                   ...
                   //MessageBox.Show(rdr1["liqueur_key"].ToString());
                    ...
                    SQLiteCommand cmd1 = new SQLiteCommand("SELECT name, amt1, amt2, amt3, amt4, amt5, amt6, amt7, amt8, amt9, amt10, amt11, amt12, directions," +
                                                        ...
                                                        "ingredient10, ingredient11, ingredient12 FROM " + FavoritesTable + " WHERE " + FavoritesTablekey + "=" + (rdr1[FavoritesTablekey]) + "", cs22);
                    ...
                    while (rdring.Read())
                    {
                        ...
                        cmd2.CommandText = @"INSERT into Favorites (name, amt1, amt2, amt3, amt4, amt5, amt6, amt7, amt8, amt9, amt10, amt11, amt12, directions,
                                                            ingredient1, ingredient2, ingredient3, ingredient4, ingredient5, ingredient6, ingredient7, ingredient8, ingredient9,
                                                            ingredient10, ingredient11, ingredient12) 
                                     Values (@DrinkName,@Amt1,@Amt2,@Amt3,@Amt4,@Amt5,@Amt6,@Amt7,@Amt8,@Amt9,@Amt10,@Amt11,@Amt12,@Directions,
                        ...
                        //cmd.Parameters.Add(new SQLiteParameter("@Amt13", rdring[0]));
                        //cmd.Parameters.Add(new SQLiteParameter("@Amt14", rdring[0]));
                        //cmd.Parameters.Add(new SQLiteParameter("@Amt15", rdring[0]));
                        cmd2.Parameters.Add(new SQLiteParameter("@Directions", rdring[13]));
                        cmd2.Parameters.Add(new SQLiteParameter("@Ing1", rdring[14]));
                        cmd2.Parameters.Add(new SQLiteParameter("@Ing2", rdring[15]));
                        cmd2.Parameters.Add(new SQLiteParameter("@Ing3", rdring[16]));
                        cmd2.Parameters.Add(new SQLiteParameter("@Ing4", rdring[17]));
                        cmd2.Parameters.Add(new SQLiteParameter("@Ing5", rdring[18]));
                        cmd2.Parameters.Add(new SQLiteParameter("@Ing6", rdring[19]));
                        cmd2.Parameters.Add(new SQLiteParameter("@Ing7", rdring[20]));
                        cmd2.Parameters.Add(new SQLiteParameter("@Ing8", rdring[21]));
                        cmd2.Parameters.Add(new SQLiteParameter("@Ing9", rdring[22]));
                        cmd2.Parameters.Add(new SQLiteParameter("@Ing10", rdring[23]));
                        cmd2.Parameters.Add(new SQLiteParameter("@Ing11", rdring[24]));
                        cmd2.Parameters.Add(new SQLiteParameter("@Ing12", rdring[25]));
                        //cmd.Parameters.Add(new SQLiteParameter("@Ing13", rdring[0]));
                        //cmd.Parameters.Add(new SQLiteParameter("@Ing14", rdring[0]));
                        //cmd.Parameters.Add(new SQLiteParameter("@Ing15", rdring[0]));
