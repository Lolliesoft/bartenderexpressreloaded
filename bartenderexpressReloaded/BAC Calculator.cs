...
namespace bartenderexpressReloaded
{
    public partial class BAC_Calculator : Form
    {
        ...
        public void calc(object sender, System.EventArgs e)
        {
            ...
            //if textboxes not empty then
            if (string.IsNullOrWhiteSpace(valWeight.Text) || (string.IsNullOrWhiteSpace(valDrinks.Text)
                || (string.IsNullOrWhiteSpace(valHours.Text))))
            {
                MessageBox.Show("Enter a Value Please.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        ...
        private void valWeight_KeyPress(object sender, KeyPressEventArgs e)
        {
            e.Handled = !char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar);
        }

        private void valDrinks_KeyPress(object sender, KeyPressEventArgs e)
        {
            e.Handled = !char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar);
        }

        private void valHours_KeyPress(object sender, KeyPressEventArgs e)
        {
            e.Handled = !char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar);
        }
    }
